...
#region Faculty
                    if (!assessmentContext.Faculty.Any()) {
                        assessmentContext.Faculty.AddRange(new [] {
                            new Faculty {  Id = 15937, RubricId  = "IL", FirstName = "Professor", LastName = "15937", },
                            new Faculty {  Id = 73915, RubricId  = "QR", FirstName = "Professor", LastName = "73915", },
                            new Faculty {  Id = 585256, RubricId  = "WC", FirstName = "Professor", LastName = "585256", },
                            new Faculty {  Id = 95137, RubricId  = "SR", FirstName = "Professor", LastName = "95137", },
                            new Faculty {  Id = 281739, RubricId  = "CT", FirstName = "Professor", LastName = "281739", },
                            new Faculty {  Id = 678432, RubricId  = "CE", FirstName = "Professor", LastName = "678432", },
                        });
